...
export function getSliderView(): string {
  return `
    <div class="container">
      ...
      <div class="games-slider">
        <div class="games-slider__item">
          <img src="" alt="" class="games-slider__item-img" />
          <h3 class="games-slider__item-title"></h3>
          <div class="games-slider__item-stats">
            <div class="games-slider__item-rating">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <div class="games-slider__item-likes">
              <svg
                width="20"
                height="19"
                viewBox="0 0 20 19"
